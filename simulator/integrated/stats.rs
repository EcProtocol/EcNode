...
pub struct RoundMetrics {
    ...
    pub avg_dense_linear_target_fit: f64,
    pub avg_dense_linear_core_coverage: f64,
    pub avg_dense_linear_fade_coverage: f64,
    pub avg_dense_linear_fade_target: f64,
    pub avg_dense_linear_far_coverage: f64,
    pub avg_dense_linear_expected_active_degree: f64,
...
pub struct SimResult {
    ...
    pub final_avg_dense_linear_target_fit: f64,
    pub avg_dense_linear_target_fit_over_time: f64,
    pub final_avg_dense_linear_core_coverage: f64,
    pub avg_dense_linear_core_coverage_over_time: f64,
    pub final_avg_dense_linear_fade_coverage: f64,
    pub avg_dense_linear_fade_coverage_over_time: f64,
    pub final_avg_dense_linear_fade_target: f64,
    pub final_avg_dense_linear_far_coverage: f64,
    pub avg_dense_linear_far_coverage_over_time: f64,
    pub final_avg_dense_linear_expected_active_degree: f64,
...
impl SimResult {
    pub fn print_summary(&self) {
        ...
        println!(
            "Fixed dense-linear target: active ideal {:.1}, fit final/avg {:.3}/{:.3}, core {:.3}/{:.3}, fade actual/avg/target {:.3}/{:.3}/{:.3}, far {:.3}/{:.3}",
            self.final_avg_dense_linear_expected_active_degree,
            self.final_avg_dense_linear_target_fit,
            self.avg_dense_linear_target_fit_over_time,
            self.final_avg_dense_linear_core_coverage,
            self.avg_dense_linear_core_coverage_over_time,
            self.final_avg_dense_linear_fade_coverage,
            self.avg_dense_linear_fade_coverage_over_time,
            self.final_avg_dense_linear_fade_target,
            self.final_avg_dense_linear_far_coverage,
            self.avg_dense_linear_far_coverage_over_time,
        );
        println!(
